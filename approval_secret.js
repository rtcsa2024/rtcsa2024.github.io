...
script.src = 'eximbay_approval_secret.js';
document.head.appendChild(script);

var script = document.createElement('script');
script.src = 'kgmob_approval_secret.js';
document.head.appendChild(script);
  ...
  if (registration === 'no') {
      ...
      if(document.getElementById('total_fee')){
        ...
        regType.innerHTML = `
            ...
            <option value="NO">Exceptional payment(USD 0)</option>
        `;
      }
      else {
        // for non-author
        ...
        regType.innerHTML = `
            ...
            <option value="NO">Exceptional payment(KRW 0)</option>
        `;
      }
  } else {
